...
function sanpham_insert($id_sanpham, $ten_sanpham, $avatar, $gia, $soluong, $ngaynhap, $nameadd, $id_diadiem,  $diachi_chitiet, $luotxem, $chitiet)
{
    $trangthai = 1;
    ...
    pdo_execute($sql, $id_sanpham, $ten_sanpham, $avatar, $gia, $soluong, $ngaynhap, $nameadd, $id_diadiem, $trangthai, $diachi_chitiet, $luotxem, $chitiet);
}
...
function aaaa($x, $a, $b, $c)
{
    $sql = "INSERT INTO blog VALUES (?,?,?,?)";
    pdo_execute($sql, $x, $a, $b, $c);
}
