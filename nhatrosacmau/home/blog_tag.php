    ...
    <div class="blog_news  w-80 overflow-hidden my-16 ml-4">
        ...
        ?>
            <a href="<?= BASE_URL . "home/index.php?blogid=" . $blog['id_blog'] ?>" class="no-underline flex cursor-pointer pt-2 ">
                <img class="w-20 h-20" src="<?= BASE_URL_ADMIN . "blog/images/" . $blog['anh'] ?>" alt="">
                <p class="truncate w-full border-b border-gray-300 py-2 mt-1"> <?= $blog['tieu_de'] ?> <br> <span class=""><?= $blog['noi_dung'] ?> </span></p>
            </a>
        <?php } ?>
