<section>
    <form method="GET" action="../home/index.php" class="container mx-auto flex justify-center mt-5 mb-5">
        <input name="kyw" class="w-6/12 border rounded-md pl-10 pr-4 py-2 focus:border-blue-500 focus:outline-none focus:shadow-outline" type="text" placeholder="Search">
    </form>
</section>
